...
local function create_sections(window)
  ...
  wezbar_x = insert_component_separators(util.extract_components(sections.wezbar_x, attributes_x, window, true), false)
  wezbar_y = insert_component_separators(util.extract_components(sections.wezbar_y, attributes_y, window, true), false)
  wezbar_z = insert_component_separators(util.extract_components(sections.wezbar_z, attributes_z, window, true), false)
end
